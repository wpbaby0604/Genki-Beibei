...
def render_beibei(audio_data: str = "", bg_image: str = "", ai_webp: str = None, companion_mode: int = 1, model_scale: float = 1.0, model_x: int = 0, model_y: int = 0, key=None, emotion: str = "neutral", forced_action: str = "", show_camera: bool = False):
    component_value = _component_func(
        ...
        show_camera=show_camera,      # 🎥 Demo：顯示右下角攝影機預覽窗（含 EAR 與閉眼倒數）
        key=key,
        default=0
    )
